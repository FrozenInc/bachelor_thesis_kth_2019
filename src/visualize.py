...
class Visualizer(object):
    ...
    # tar hand om vad personen trycker pa knapp
    ...
    # hur kameran ser ut, var den ar nanstans, hur in zoomad den ska vara
    def camera(self):
        o = self.center()
        gl.glOrtho(o[0]-1./self.magnify, o[0]+1./self.magnify, o[1]-1./self.magnify, o[1]+1./self.magnify, -1., 1.)
    # fixar heatmat enligt rewards
    def set_heat(self, f):
        x = utils.vector(4)
        u = utils.vector(2)
    ...
    # ritar ut sakerna och pushar tiden fram med 1
    ...
    def draw_object(self, obj):
        ...
        sprite.draw()
    #  hur den ska rita ut hela varlden med hjalp av de andra funktionerna
    def on_draw(self):
        self.window.clear()
    ...
    # resetar varlden till dess start varden
    def reset(self):
        for car in self.cars:
            car.reset()
        self.prev_t = time.time()
    ...
    # kor hela visualize varlden och kor
