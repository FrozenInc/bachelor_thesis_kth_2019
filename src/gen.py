...
def isempty(data): # kollar om en fil ar tom
    return all([len(y)==0 for y in data.values()])

csvs = [[], [], []]

# fixar farger for olika varldar
condition = {
    'world0': 'gray',
    'world1': 'orange',
    'world2': 'orange',
...
#laddar alla csv for alla scenarios
...
# tar fram alla bilder och laddar in de for att rita ut det i viz
